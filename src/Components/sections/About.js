...
const img4 = require('/Users/Jake.Squier/portfolioFinal/p0rtf0li0/src/images/image4.jpeg').default
                ...
                <div id="aboutContent">
                    <div className='about-content'>
                        <div id="aboutTextContainer">
                            ...
                            <p className='intro-text'>Hello! My name is Jacob Squier. I relish the idea of creating online software applications that bring convenience and joy. My interest in software began in middle school when I began writing batch scripts to tamper with my school laptop. Coding became the only thing that wasn't interrupted by my <span id='keyWord'>ADHD</span>.</p>
                            <p className='present-text'>Fast-forward to the present I am a <span id='keyWord'>Flatiron</span> grad, In fact, I got to be one of the youngest to graduate due to the fact I enrolled at 17. I have been a freelance developer since then and am now beginning my job search as of July 2022. I stay curious and love to develop in general.</p>
